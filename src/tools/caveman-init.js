...
//   curl -fsSL https://raw.githubusercontent.com/VladBullet/caveman-skill/main/src/tools/caveman-init.js | node - [args]
//
...
function processOpenclaw(opts) {
  ...
  if (!helper) {
    return {
      ...
      label: 'x',
      detail: '~/.openclaw/workspace (helper unavailable in standalone curl|node mode — use `npx -y github:VladBullet/caveman-skill -- --only openclaw`)',
    };
  }
