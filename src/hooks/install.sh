...
#   or:  bash <(curl -s https://raw.githubusercontent.com/VladBullet/caveman-skill/main/src/hooks/install.sh)
...
REPO_URL="https://raw.githubusercontent.com/VladBullet/caveman-skill/main/hooks"
