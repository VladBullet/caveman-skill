...
#        irm https://raw.githubusercontent.com/VladBullet/caveman-skill/main/src/hooks/install.ps1 | iex
...
$RepoUrl = "https://raw.githubusercontent.com/VladBullet/caveman-skill/main/hooks"
