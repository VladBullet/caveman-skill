...
2. Otherwise download and run the standalone script (it is self-contained and supports stdin execution): `curl -fsSL https://raw.githubusercontent.com/VladBullet/caveman-skill/main/src/tools/caveman-init.js | node - $ARGUMENTS`
